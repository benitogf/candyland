...
// automatically teaches the usage-limit classifier about it. detritus's in-session
// settings surface (settings.go modelAliases) mirrors this list — kept in sync
// manually, since the two surfaces share no code.
