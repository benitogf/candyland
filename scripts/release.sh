...
echo "The release workflow builds the standalone binaries (version injected via"
echo "-ldflags) and publishes the GitHub Release."
echo "If you don't see a release run, the workflow is still at ci/release.yml —"
